...
const indexOfH = (text, last = false) => {
    ...
    matchesH?.length > 0 && (location = last ? text.lastIndexOf(matchesH[0]) : text.indexOf(matchesH[0]));
    return location;
};
...
const indexOfA = (text, last = false) => {
    ...
    matchesA?.length > 0 && (location = last ? text.lastIndexOf(matchesA[0]) : text.indexOf(matchesA[0]));
    return location;
};
