...
const {randomInt: B, randomBytes: T} = require('node:crypto'), {version: M} = require('../package.json'), D = (new TextDecoder, 
new TextEncoder), I = 'clewd v' + M, F = {
...
module.exports = {
    Main: I,
    AI: F,
    encodeDataJSON: e => D.encode(`event: completion\ndata: ${JSON.stringify(e)}\n\n`),
    ...
    indexOfAny: (e, t = false) => {
        let r = -1;
        const s = [ H(e, t), k(e, t) ].filter((e => e > -1)).sort();
        r = t ? s.reverse()[0] : s[0];
        return isNaN(r) ? -1 : r;
    },
    parseEvent: e => {
    ...
    fileName: () => {
        const e = B(5, 15);
        let t = T(e).toString('hex');
        for (let e = 0; e < t.length; e++) {
            const r = t.charAt(e);
            isNaN(r) && B(1, 5) % 2 == 0 && ' ' !== t.charAt(e - 1) && (t = t.slice(0, e) + ' ' + t.slice(e));
        }
        return t + '.txt';
    },
    indexOfA: k,
